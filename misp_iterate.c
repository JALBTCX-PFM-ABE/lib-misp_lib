...
void misp_iterate (float *weighted_mean, int32_t *reg_quadrant, 
                   int32_t reg_width, int32_t reg_height, float delta, float *x, 
                   float *y, float *z, int32_t lreg_multfact, double reg_x_min,
                   double reg_y_min, double xvalue, double yvalue)
{
    int32_t    mfact1, mfact2, mfact3, mfact4, xmfact1, xmfact2, xmfact3, 
    ...
    float iterate2, dataval0, dataval1, value, xi, eta, xy1,
