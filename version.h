...
#define     VERSION     "PFM Software - libmisp V1.44 - 07/22/14"
...
/*
    ...
    Removed a few [-Wunused-but-set-variable] variables from misp_iterate.c,
    misps.c, merge_grid.c, and readsparse.c.
    ...
    Replaced nvtypes.h data types with stdint.h data types (e.g. uint32_t instead of uint32_t).
