...
void edge (float *memblock1, float *mergeblock, float *x, 
    int32_t y_start, int32_t y_end, int32_t rownum1, int32_t weight_factor,
    int32_t final_height, int32_t final_width)
{
    float        average;
    int32_t      good_count, increment, rownum2, index1, index2;
