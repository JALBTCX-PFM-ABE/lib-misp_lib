...
void merge (float *memblock1, float *mergeblock, float *x, 
    int32_t final_width, int32_t final_height, int32_t rownum, 
    int32_t rowpos, int32_t weight_factor)
{
    float        average;
    int32_t      position1, good_count, position3, valpos1, valpos2, index1, 
                 index2, index3;
